...
if ( ! function_exists('test_method'))
{
    ...
    function icon_sm(){
        return "http://arkademy.com/asset/images/ico_sm.png";
    }
    ...
    */
    ...
    function start_cokkies($username,$password,$role){
        ...
        if ($remember!=NULL) {
            setcookie('u_cook_name',$username, time() + (86400*7),"/");
            setcookie('u_cook_pwd',$password, time() + (86400*7),"/");
            setcookie('u_role',$role, time() + (86400*7),"/");
        }
    }
